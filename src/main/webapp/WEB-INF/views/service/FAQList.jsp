...
window.onload = function(){
	...
	var keyArray = tab.split('=');
	var keyArray2 = keyArray[1].split('&');
	
	if(keyArray[0]=='?FAQCategory'){
		var key = keyArray2[0];
	}
	
	if(key =='undefined'){
		//탭 변경
		document.getElementById("totalTab").style.display="";
		document.getElementById("policyTab").style.display="none";
		document.getElementById("commonTab").style.display="none";
		document.getElementById("buyTab").style.display="none";
		document.getElementById("sellTab").style.display="none";
		
		//버튼 변경 - 선택 시
		document.getElementById("totalTabBtn").style.border="1px solid #222";
		document.getElementById("totalTabBtn").style.color="#fff";
		document.getElementById("totalTabBtn").style.background="#222";
		document.getElementById("totalTabBtn").style.fontWeight="bold";
		
		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("policyTabBtn").style.border="1px solid #22222280";
		document.getElementById("policyTabBtn").style.color="#22222280";
		document.getElementById("policyTabBtn").style.background="#fff";
		document.getElementById("policyTabBtn").style.fontWeight="normal";

		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("commonTabBtn").style.border="1px solid #22222280";
		document.getElementById("commonTabBtn").style.color="#22222280";
		document.getElementById("commonTabBtn").style.background="#fff";
		document.getElementById("commonTabBtn").style.fontWeight="normal";

		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("buyTabBtn").style.border="1px solid #22222280";
		document.getElementById("buyTabBtn").style.color="#22222280";
		document.getElementById("buyTabBtn").style.background="#fff";
		document.getElementById("buyTabBtn").style.fontWeight="normal";

		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("sellTabBtn").style.border="1px solid #22222280";
		document.getElementById("sellTabBtn").style.color="#22222280";
		document.getElementById("sellTabBtn").style.background="#fff";
		document.getElementById("sellTabBtn").style.fontWeight="normal";
		...
		document.getElementById("policyTab").style.display="";
		document.getElementById("commonTab").style.display="none";
		document.getElementById("buyTab").style.display="none";
		document.getElementById("sellTab").style.display="none";
		
		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("totalTabBtn").style.border="1px solid #22222280";
		document.getElementById("totalTabBtn").style.color="#22222280";
		document.getElementById("totalTabBtn").style.background="#fff";
		document.getElementById("totalTabBtn").style.fontWeight="normal";
		
		//버튼 변경 - 선택 시
		document.getElementById("policyTabBtn").style.border="1px solid #222";
		document.getElementById("policyTabBtn").style.color="#fff";
		document.getElementById("policyTabBtn").style.background="#222";
		document.getElementById("policyTabBtn").style.fontWeight="bold";
		...
		document.getElementById("totalTab").style.display="none";
		document.getElementById("policyTab").style.display="none";
		document.getElementById("commonTab").style.display="";
		document.getElementById("buyTab").style.display="none";
		document.getElementById("sellTab").style.display="none";
		...
		//버튼 변경 - 선택 시
		document.getElementById("commonTabBtn").style.border="1px solid #222";
		document.getElementById("commonTabBtn").style.color="#fff";
		document.getElementById("commonTabBtn").style.background="#222";
		document.getElementById("commonTabBtn").style.fontWeight="bold";
		...
		document.getElementById("policyTab").style.display="none";
		document.getElementById("commonTab").style.display="none";
		document.getElementById("buyTab").style.display="";
		document.getElementById("sellTab").style.display="none";
		...
		//버튼 변경 - 선택 시
		document.getElementById("buyTabBtn").style.border="1px solid #222";
		document.getElementById("buyTabBtn").style.color="#fff";
		document.getElementById("buyTabBtn").style.background="#222";
		document.getElementById("buyTabBtn").style.fontWeight="bold";
		...
		document.getElementById("commonTab").style.display="none";
		document.getElementById("buyTab").style.display="none";
		document.getElementById("sellTab").style.display="";
		...
		//버튼 변경 - 선택 시
		document.getElementById("sellTabBtn").style.border="1px solid #222";
		document.getElementById("sellTabBtn").style.color="#fff";
		document.getElementById("sellTabBtn").style.background="#222";
		document.getElementById("sellTabBtn").style.fontWeight="bold";
...
<div id="nuxt" style="box-sizing: border-box; color: rgb(34, 34, 34); display: block; font-size: 14px; font-weight: 400;
	...
	<div id="layout" style="box-sizing: border-box; color: rgb(34, 34, 34); display: block;">
		...
		<div class="wrap win_os lg" style="position: relative; padding-top: 100px;">
			...
			<div align="center">
	<div align="center" style="width: 1300px; height:700px; padding: 40px;">
		<table cellpadding="0" cellspacing="0" >
		<tr valign="top">
		
			<td style="width: 250px;">
				<h2 style="margin: 0px;padding-bottom:25px; cursor: pointer;font-weight: 700;width: 250px;height: 63px;" 
				onclick="location.href='<%=cp%>/noticeList'">고객센터</h2>
				<div>
					<!-- <div class="content"><strong>고객센터</strong></div> -->
					
					<ul>
						<li class="menu" onclick="location.href='<%=cp%>/noticeList'">공지사항</li>
						<li class="menu" onclick="location.href='<%=cp%>/FAQList'" style="color: black; font-weight: bolder;">자주 묻는 질문</li>
						<li class="menu" onclick="location.href='<%=cp%>/questionList'">1 : 1 문의</li>
			...
			<div style="padding-top:5px">
				...
				<!-- 내용 테이블 시작 -->
				<table class="noticeListContent" style="width: 1000px; font-size: 13px;">
				

				<!-- 탭 버튼 -->
				<tr style="height: 80px; border-bottom: solid 1px #ebebeb;">
					<td colspan="3" valign="middle">
						<div style="display: flex;">

							<div style="width: 68px; height: 40px; padding: 10px 14px; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #222; color: #fff; background-color: #222; font-weight: bold;" 
							align="center" id="totalTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/FAQList'">
								전체
							</div>
							
							<div style="width: 88px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;"
							align="center" id="policyTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/FAQList?FAQCategory=1';">
								이용정책
							</div>
							
							<div style="width: 68px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;" 
							align="center" id="commonTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/FAQList?FAQCategory=2'">
								공통
							</div>
							
							<div style="width: 68px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;" 
							align="center" id="buyTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/FAQList?FAQCategory=3'">
								구매
							</div>
							...
							<div style="width: 68px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;" 
							align="center" id="sellTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/FAQList?FAQCategory=4'">
								판매
							</div>
				...
				<div id="totalTab">
					...
					<tr class="noticeListContent" onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
					onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
						<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
						<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
					...
					<!-- 페이징 -->
					<div style="margin-top: 30px; color: #222;">
				...
				<!-- 이용정책 내용 -->
				<div id="policyTab" style="display: none;">
					<table class="noticeListContent" style="width: 1000px; font-size: 13px;">
					<c:forEach var="dto" items="${tabLists }">
					<tr class="noticeListContent"
					onclick="location.href='${tabArticleUrl }&FAQNum='+${dto.FAQNum }" 
					onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
						<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
						<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
						<td align="center" style="width: 100px; color: #919191; padding-right: 10px;">${dto.FAQCreated }</td>
				...
				<!-- 구매 내용 -->
				<div id="buyTab" style="display: none;">
					<table class="noticeListContent" style="width: 1000px; font-size: 13px;">
					<c:forEach var="dto" items="${tabLists }">
					<tr class="noticeListContent"
					onclick="location.href='${tabArticleUrl }&FAQNum='+${dto.FAQNum }" 
