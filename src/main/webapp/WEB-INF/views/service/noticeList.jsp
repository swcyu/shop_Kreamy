	...
	<div align="center" style="width: 1300px; height:700px; padding: 40px;">
		...
		<tr valign="top">
			...
			<div>
					...
					<ul>
						<li class="menu" onclick="location.href='<%=cp%>/noticeList'" style="color: black; font-weight: bolder;">공지사항</li>
			...
			<div style="padding-top:5px">
				...
				<table class="noticeListContent" style="width: 1000px; font-size: 13px;">
					...
					<c:forEach var="dto" items="${lists }">
						<tr class="noticeListContent" onclick="location.href='${articleUrl }&noticeNum='+${dto.noticeNum }" 
						onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
							<td style="font-size: 15px; padding-left: 20px;"><b>[${dto.noticeCategory }]</b> ${dto.noticeTitle }</td>
							<td align="center" style="width: 100px; color: #919191; padding-right: 10px;">${dto.noticeCreated }</td>
						</tr>
					</c:forEach>	
