...
function changeTab(key){
	...
	if(key =='스니커즈'){
		//탭 변경
		document.getElementById("sneakersTab").style.display="";
		document.getElementById("fashionTab").style.display="none";
		document.getElementById("techTab").style.display="none";
		document.getElementById("lifeTab").style.display="none";
		
		//버튼 변경 - 선택 시
		document.getElementById("sneakersTabBtn").style.border="1px solid #222";
		document.getElementById("sneakersTabBtn").style.color="#fff";
		document.getElementById("sneakersTabBtn").style.background="#222";
		document.getElementById("sneakersTabBtn").style.fontWeight="bold";
		
		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("fashionTabBtn").style.border="1px solid #22222280";
		document.getElementById("fashionTabBtn").style.color="#22222280";
		document.getElementById("fashionTabBtn").style.background="#fff";
		document.getElementById("fashionTabBtn").style.fontWeight="normal";

		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("techTabBtn").style.border="1px solid #22222280";
		document.getElementById("techTabBtn").style.color="#22222280";
		document.getElementById("techTabBtn").style.background="#fff";
		document.getElementById("techTabBtn").style.fontWeight="normal";

		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("lifeTabBtn").style.border="1px solid #22222280";
		document.getElementById("lifeTabBtn").style.color="#22222280";
		document.getElementById("lifeTabBtn").style.background="#fff";
		document.getElementById("lifeTabBtn").style.fontWeight="normal";

		
		
	}else if(key =='의류 / 패션 잡화'){	

		//탭 변경
		document.getElementById("sneakersTab").style.display="none";
		document.getElementById("fashionTab").style.display="";
		document.getElementById("techTab").style.display="none";
		document.getElementById("lifeTab").style.display="none";
		
		//버튼 변경 - 선택 안 됐을 경우
		document.getElementById("sneakersTabBtn").style.border="1px solid #22222280";
		document.getElementById("sneakersTabBtn").style.color="#22222280";
		document.getElementById("sneakersTabBtn").style.background="#fff";
		document.getElementById("sneakersTabBtn").style.fontWeight="normal";
		
		//버튼 변경 - 선택 시
		document.getElementById("fashionTabBtn").style.border="1px solid #222";
		document.getElementById("fashionTabBtn").style.color="#fff";
		document.getElementById("fashionTabBtn").style.background="#222";
		document.getElementById("fashionTabBtn").style.fontWeight="bold";
		...
		//버튼 변경 - 선택 시
		document.getElementById("techTabBtn").style.border="1px solid #222";
		document.getElementById("techTabBtn").style.color="#fff";
		document.getElementById("techTabBtn").style.background="#222";
		document.getElementById("techTabBtn").style.fontWeight="bold";
		...
		document.getElementById("fashionTab").style.display="none";
		document.getElementById("techTab").style.display="none";
		document.getElementById("lifeTab").style.display="";
		...
		//버튼 변경 - 선택 시
		document.getElementById("lifeTabBtn").style.border="1px solid #222";
		document.getElementById("lifeTabBtn").style.color="#fff";
		document.getElementById("lifeTabBtn").style.background="#222";
		document.getElementById("lifeTabBtn").style.fontWeight="bold";
		...
		<tr valign="top">
			...
			<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/authPolicy'" style="color: black; font-weight: bolder;">검수 기준</li>
					</ul>
				</div>
			</td>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">검수 기준</h3>
					</div>
 				</div>
				...
				<tr style="height: 80px; border-bottom: solid 1px #ebebeb;">
					<td valign="middle">
						<div style="display: flex;">
							...
							<div style="width: 98px; height: 40px; padding: 10px 14px; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #222; color: #fff; background-color: #222; font-weight: bold;" 
							align="center" id="sneakersTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="changeTab('스니커즈');">
								스니커즈
							</div>
							
							<div style="width: 128px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;"
							align="center" id="fashionTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="changeTab('의류 / 패션 잡화');">
								의류 / 패션 잡화
							</div>
							
							<div style="width: 68px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;" 
							align="center" id="techTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="changeTab('테크');">
								테크
							</div>
							
							<div style="width: 78px; height: 40px; padding: 10px 14px ; margin:7px; border-radius: 20px; cursor: pointer;
							font-size: 13px; border: 1px solid #22222280; color: #22222280; background-color: #fff; font-weight: normal;" 
							align="center" id="lifeTabBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="changeTab('라이프');">
								라이프
							</div>
				...
				<!-- 스니커즈 내용 -->
				<tr id="sneakersTab" style="border-bottom: solid 1px #ebebeb;">
					<td align="left">
						<div align="left" style="padding: 50px; font-size: 14px; position: relative; font-size: 15px; line-height: 2;">
							<img src="<%=cp %>/resources/image/authPolicy/authPolicySneakers.png">
						</div>
				...
				<!-- 의류 / 패션 잡화 내용 -->
				<tr id="fashionTab" style="border-bottom: solid 1px #ebebeb; display: none;">
					<td align="left">
						<div align="left" style="padding: 50px; font-size: 14px; position: relative; font-size: 15px; line-height: 2;">
							<img src="<%=cp %>/resources/image/authPolicy/authPolicyFashion.png">
						</div>
				...
				<!-- 테크 내용 -->
				<tr id="techTab" style="border-bottom: solid 1px #ebebeb; display: none;">
					<td align="left">
						<div align="left" style="padding: 50px; font-size: 14px; position: relative; font-size: 15px; line-height: 2;">
							<img src="<%=cp %>/resources/image/authPolicy/authPolicyTech.png">
						</div>
				...
				<!-- 라이프 내용 -->
				<tr id="lifeTab" style="border-bottom: solid 1px #ebebeb; display: none;">
					<td align="left">
						<div align="left" style="padding: 50px; font-size: 14px; position: relative; font-size: 15px; line-height: 2;">
							<img src="<%=cp %>/resources/image/authPolicy/authPolicyLife.png">
						</div>
