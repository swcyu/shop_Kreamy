	...
	<div align="center" style="width: 1300px; padding: 40px;">
		...
		<tr valign="top">
			...
			<div style="padding-top:5px">
				...
				<tr style="height: 80px; border-bottom: solid 1px #ebebeb;">
					<td colspan="3" valign="middle">
						<div style="display: flex;">
							...
							onclick="location.href='<%=cp%>/FAQList?FAQCategory=1'; changeTab('이용정책');">
								이용정책
							</div>
				...
				<tr id="totalTab" class="noticeListContent" onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
				...
				<tr id="policyTab" class="noticeListContent" style="display: none;"
				onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
				onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
					<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
					<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
					<td align="center" style="width: 100px; color: #919191; padding-right: 10px;">${dto.FAQCreated }</td>
				...
				<!-- 공통 내용 -->
				<c:forEach var="dto" items="${tabLists }">
				<c:if test="${dto.FAQCategory eq '공통' }">
				<tr id="commonTab" class="noticeListContent" style="display: none;"
				onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
				onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
					<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
					<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
				...
				<!-- 구매 내용 -->
				<c:forEach var="dto" items="${tabLists }">
				<c:if test="${dto.FAQCategory eq '구매' }">
				<tr id="buyTab" class="noticeListContent" style="display: none;"
				onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
				onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
					<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
					<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
				...
				<!-- 판매 내용 -->
				<c:forEach var="dto" items="${tabLists }">
				<c:if test="${dto.FAQCategory eq '판매' }">
				<tr id="sellTab" class="noticeListContent" style="display: none;"
				onclick="location.href='${articleUrl }&FAQNum='+${dto.FAQNum }" 
				onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
					<td style="width: 100px; font-size: 15px; padding-left: 20px;"><b>${dto.FAQCategory }</b></td>
					<td colspan="6" style="font-size: 15px;">${dto.FAQTitle }</td>
