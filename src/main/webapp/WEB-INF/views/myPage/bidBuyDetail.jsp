...
function deleteBid(bidBuyNum){
	var url = "<%=cp%>/deleteBidBuy"
	$.post(url,{bidBuyNum:bidBuyNum},function(args){})
	$(location).attr('href','<%=cp%>/buying');
}
			...
			<td style="padding-left: 40px; width: 1000px;" align="center">
					...
					<div style="color: #222; margin: 0px;  padding: 5px 0px;width: 1000px;">
						<div style="color: #222; margin: 0px; display: flex;">
							<div style="float: left; width: 500px;" align="left" id="title">
								<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">구매내역 > 입찰 중</h3>
							</div>
							<div style="margin-left: auto;padding-left: 30px;flex-shrink: 0;display: flex;">
								<div style="cursor: pointer;vertical-align: middle;text-align: center;background-color: #fff;display: flex;
							    margin-right: -6px;padding: 0 6px;-webkit-box-align: center;align-items: center;font-size: 14px;letter-spacing: -.21px;"
							    data-bs-toggle="modal" data-bs-target="#deleteModal">
							    	<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-delete" fill="none" viewBox="0 0 24 24" style="
							    	width: 20px; cursor: pointer;text-align: center;font-size: 14px; letter-spacing: -.21px;margin-right: 4px;">
									<path fill="#000" fill-rule="evenodd" d="M8.94 2.94c.28-.282.662-.44 1.06-.44h4c.398 0 .78.158 1.06.44.282.28.44.662.44 
									1.06v1.5h-7V4c0-.398.158-.78.44-1.06zM7.5 5.5V4A2.5 2.5 0 0110 1.5h4A2.5 2.5 0 0116.5 4v1.5H21a.5.5 0 010 1h-1.5V20a2.5 
									2.5 0 01-2.5 2.5H7A2.5 2.5 0 014.5 20V6.5H3a.5.5 0 010-1h4.5zm-2 1V20c0 .398.158.78.44 1.06.28.282.662.44 1.06.44h10c.398 
									0 .78-.158 1.06-.44.282-.28.44-.662.44-1.06V6.5h-13zm4.5 4a.5.5 0 01.5.5v6a.5.5 0 01-1 0v-6a.5.5 0 01.5-.5zm4.5.5a.5.5 0 
									00-1 0v6a.5.5 0 001 0v-6z" clip-rule="evenodd"></path></svg>
									<span style="cursor: pointer;text-align: center;font-size: 14px;letter-spacing: -.21px;">삭제하기</span>
							    </div>
				...
				<div>
					<div>
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
    						...
    						font-weight: 700;"> BB-${bidBuyDTO.bidBuyNum } </em>
    						</h4>
						</div>
					</div>
					<div style="position: relative;border-top: 2px solid #222;">
						<div style="display: flex;padding: 16px 105px 16px 0;border-bottom: 1px solid #ebebeb;">
							<div style="-webkit-box-flex: 0;flex: none;width: 100px;height: 100px;">
								<div style="overflow: hidden;position: relative;padding-top: 100%;border-radius: 12px;background-color: rgb(244, 244, 244);">
									<img src="/img/${bidBuyDTO.imageName}" 
    						...
    						align-self: center;">
								<strong style="-webkit-box-direction: normal;display: inline-flex;font-size: 14px;">${bidBuyDTO.condition } · ${bidBuyDTO.styleNum }</strong>
								<p style="margin: 0;padding: 0;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 2;
							    -webkit-box-orient: vertical;margin-top: 4px;font-size: 14px;">${bidBuyDTO.engProduct }</p>
							    <span style="margin-top: 4px;font-size: 14px;display: inline-flex;letter-spacing: -.21px;font-weight: 700;
    							color: rgba(34,34,34,.5);">${bidBuyDTO.userSize }</span>
							</div>
						</div>
								...
								<li style="list-style: none;padding: 16px 0 20px;display: table-cell;text-align: center;">
									<div style="position: relative;">
										...
										<p style="text-align: center;margin: 0;">
											<span style="display: inline-block;font-size: 14px;">${bidBuyDTO.immediateBuyPrice }</span>
										</p>
									</div>
								</li>
								<li style="list-style: none;padding: 16px 0 20px;display: table-cell;text-align: center;">
									<div style="position: relative;" class="item_inner">
										...
										<p style="text-align: center;margin: 0;">
											<span style="display: inline-block;font-size: 14px;">${bidBuyDTO.immediateSellPrice }</span>
										</p>
									</div>
								</li>
							</ul>
						...
						<div style="position: absolute;top: 49px;right: 0;">
						    ...
						    border: 1px solid #d3d3d3;color: rgba(34,34,34,.8);"onclick="location.href='<%=cp%>/products?prodNum=${bidBuyDTO.productNum }'">상품 상세보기</div>
						</div>
					</div>
				</div>
				<div>
					<div style="margin-top: 32px;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
							<h4 style="padding: 6px 0;margin:0px;font-size: 16px;letter-spacing: -.16px;line-height: 20px;">구매 입찰 내역</h4>
						</div>
					</div>
						...
						<div style="border-bottom: 1px solid #ebebeb;">
							<div style="background-color: #fafafa;"align="left">
								<dl style="margin: 0;padding: 0;font-weight: 700;">
								    ...
								    width: 160px;font-size: 14px;line-height: 28px;">구매 희망가</dt>
									<dd style="font-weight: 700;margin: 0;padding: 26px 0;overflow: hidden;font-size: 0;">
    									...
    									vertical-align: top;">${bidBuyDTO.wishPrice }</span>
									</dd>
								</dl>
							</div>
							<div style="margin: 0;padding: 20px 0;border-top: 1px solid #ebebeb;" align="left">
								<dl style="margin: 0;padding: 0;display: flex;-webkit-box-align: center;align-items: center;min-height: 26px;
							    font-size: 13px;letter-spacing: -.07px;-webkit-box-pack: start;justify-content: flex-start;">
									<dt style="margin: 0;padding: 0;font-size: 14px;color: #222;margin-right: 12px;padding-left: 16px;
								    width: 160px;line-height: 20px;letter-spacing: -.2px;">
								    	<span style="font-size: 14px;color: #222;line-height: 20px;letter-spacing: -.2px;box-sizing: border-box;">
								    	포인트</span>
								    	<div style="position: relative;top: 5px;padding: 0 1px;display: inline-flex; "data-bs-toggle="modal" 
										data-bs-target="#pointModal">
									    	<svg xmlns="http://www.w3.org/2000/svg" id="i-info-circle" fill="none" viewBox="0 0 20 20" style="width: 20px;">
									    	<path fill="#BBB" fill-rule="evenodd" d="M18.333 10A8.333 8.333 0 0110 18.333 8.333 8.333 0
									    	 011.667 10 8.333 8.333 0 0110 1.667 8.333 8.333 0 0118.333 10zm-8.48 3.438A.781.781 0 109.852
									    	  15h.113a.78.78 0 000-1.562h-.113zm-2.71-5.235c-.069.388.26.71.653.71s.696-.325.789-.707c.06-.249.155-.463.286-.644.25-.341.633-.512 
									    	  1.15-.512a1.259 1.259 0 01.775.312c.125.109.23.255.312.438.092.175.138.387.138.637 
									    	  0 .209-.03.388-.088.538-.05.15-.125.287-.225.412-.091.117-.2.225-.325.325l-.375.325a3.684 3.684 0 
									    	  00-.437.438 2.073 2.073 0 00-.3.5 2.863 2.863 0 00-.214.925c-.03.372.279.675.651.675.373 0
									    	   .66-.306.73-.672l.02-.09c.059-.209.138-.388.238-.538.1-.158.217-.3.35-.425.133-.125.28-.254.437-.387l.4-.35c.134-.126.25-.263.35-.413.109-.158.192-.342.25-.55.067-.217.1-.47.1-.763 
									    	   0-.4-.07-.758-.212-1.075a2.156 2.156 0 00-.588-.787 2.359 2.359 0 00-.862-.488 3.144 3.144 0 00-1.063-.175 3.34 3.34 0 00-1.25.225
									    	    2.714 2.714 0 00-.95.613 2.782 2.782 0 00-.74 1.503z" clip-rule="evenodd"></path></svg>
									    </div>
								    </dt>
							...
							<div style="margin: 0;padding: 20px 0;border-top: 1px solid #ebebeb;" align="left">
							    ...
							    letter-spacing: -.07px;-webkit-box-pack: start;justify-content: flex-start;">
							    	<dt style="color: rgba(34,34,34,.5);font-size: 14px;margin-right: 12px;padding-left: 16px;width: 160px;
    								line-height: 20px;letter-spacing: -.2px;">
    									<span style="font-size: 14px;color: #222;line-height: 20px;letter-spacing: -.2px;">입찰일</span>
    								</dt>
							    	<dd style="margin: 0;padding: 0;white-space: nowrap;color: #222;font-size: 14px;line-height: 20px;letter-spacing: -.2px;">
							    	${bidBuyDTO.bidBuyDate }</dd>
							    </dl>
								<dl style="display: flex;margin:0;-webkit-box-align: center;align-items: center;min-height: 26px;font-size: 13px;
							    letter-spacing: -.07px;-webkit-box-pack: start;justify-content: flex-start;">
							    	<dt style="color: rgba(34,34,34,.5);font-size: 14px;margin-right: 12px;padding-left: 16px;width: 160px;
    								line-height: 20px;letter-spacing: -.2px;">
    									<span style="font-size: 14px;color: #222;line-height: 20px;letter-spacing: -.2px;">입찰 마감기한</span>
    								</dt>
    								<c:if test="${bidBuyDTO.bidBuyState=='기한만료' }">
								    	<dd style="margin: 0;padding: 0;white-space: nowrap;color: #f15746;font-size: 14px;line-height: 20px;letter-spacing: -.2px;">
								    	기한만료</dd>
							    	</c:if>
    								<c:if test="${bidBuyDTO.bidBuyState!='기한만료' }">
								    	<dd style="margin: 0;padding: 0;white-space: nowrap;color: #222;font-size: 14px;line-height: 20px;letter-spacing: -.2px;">
								    	${bidBuyDTO.bidBuyValidDate }까지</dd>
							    	</c:if>
							    </dl>
							</div>
						</div>
						<div style="display: flex;-webkit-box-pack: center;justify-content: center;">
							<div style="color: inherit;-webkit-tap-highlight-color: rgba(0,0,0,.1);display: inline-block;cursor: pointer;
						    vertical-align: middle;text-align: center;background-color: #fff;padding: 0 18px;height: 42px;line-height: 40px;
						    border-radius: 12px;font-size: 14px;letter-spacing: -.14px;border: 1px solid #222;margin-top: 24px;"
						    onclick="location.href='<%=cp%>/buy?prodSize=${bidBuyDTO.userSize }&engProduct=${bidBuyDTO.engProduct }&bidBuyNum=${bidBuyDTO.bidBuyNum }&wishPrice=${bidBuyDTO.bidBuyWishPrice }'">입찰 변경하기</div>
							
							<c:if test="${bidBuyDTO.immediateBuyPrice!='-' }">
							<div style="display: inline-block;cursor: pointer;vertical-align: middle;text-align: center;padding: 0 18px;height: 42px;
						    line-height: 40px;border-radius: 12px;font-size: 14px;letter-spacing: -.14px;border: 1px solid #222;margin-top: 24px;
						    background-color: #ef6253;border-color: #ef6253;color: #fff;margin-left: 8px;" 
						    onclick="location.href='<%=cp%>/buy/check?prodSize=${bidBuyDTO.userSize }&engProduct=${bidBuyDTO.engProduct }';">즉시 구매하기</div>
						    </c:if>
						</div>			
					</div>
				</div>
				<div align="left">
					<div style="margin-top: 40px;">
						...
						<p style="margin: 0;padding: 0;padding-bottom: 6px;font-size: 12px;line-height: 14px;letter-spacing: -.12px;color: rgba(34,34,34,.5);">
						대기 중, 발송완료, 입고완료 상태에서만 배송지 변경이 가능합니다.</p>						
					</div>
					<div style="border-top: 2px solid #222;">
		...
		box-shadow: 0 4px 10px 0 rgba(0,0,0,.1); " >
			...
			<div>
				...
				<div style="padding: 24px 32px 32px;display: flex;-webkit-box-pack: center;justify-content: center;">
				    ...
				    margin-left: 8px;"data-bs-dismiss="modal" onclick="deleteBid('${bidBuyDTO.bidBuyNum}');">입찰 지우기</div>
				</div>
			</div>
