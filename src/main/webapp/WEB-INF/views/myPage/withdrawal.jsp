...
function check1(){
	...
	if(check1=='no'){
		...
		$('#check_box1').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-active' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
	...
	if(check1=='yes'){
		...
		$('#check_box1').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-inactive' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
...
function check2(){
	...
	if(check2=='no'){
		...
		$('#check_box2').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-active' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path fill='#000' d='M0 0h24v24H0z'></path><path stroke='#fff' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	if(check2=='yes'){
		document.getElementById('check2').value='no'
		$('#check_box2').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-inactive' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path stroke='#D3D3D3' d='M.5.5h23v23H.5z'></path><path stroke='#EBEBEB' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	all_check()
}
function check3(){
	...
	if(check3=='no'){
		document.getElementById('check3').value='yes'
		$('#check_box3').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-active' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path fill='#000' d='M0 0h24v24H0z'></path><path stroke='#fff' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	if(check3=='yes'){
		document.getElementById('check3').value='no'
		$('#check_box3').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-inactive' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path stroke='#D3D3D3' d='M.5.5h23v23H.5z'></path><path stroke='#EBEBEB' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	all_check()
}
function check4(){
	...
	if(check4=='no'){
		document.getElementById('check4').value='yes'
		$('#check_box4').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-active' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path fill='#000' d='M0 0h24v24H0z'></path><path stroke='#fff' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	if(check4=='yes'){
		document.getElementById('check4').value='no'
		$('#check_box4').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-inactive' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path stroke='#D3D3D3' d='M.5.5h23v23H.5z'></path><path stroke='#EBEBEB' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
	}
	all_check()
}
function check5(){
	...
	if(check5=='no'){
		document.getElementById('check5').value='yes'
		$('#check_box5').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-active' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path fill='#000' d='M0 0h24v24H0z'></path><path stroke='#fff' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
		$('#finish_button').html('<div data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#completeModal">탈퇴하기</div>')
		
	}
	if(check5=='yes'){
		document.getElementById('check5').value='no'
		$('#check_box5').html("<svg xmlns='http://www.w3.org/2000/svg' id='i-ico-check-inactive' fill='none' viewBox='0 0 24 24' style='width:24px; height: 24px;'>"+
		"<path stroke='#D3D3D3' d='M.5.5h23v23H.5z'></path><path stroke='#EBEBEB' stroke-width='1.5' d='M18.4 7.2L9.6 16l-4-4'></path></svg>")
		$('#finish_button').html('<div>탈퇴하기</div>')
	}
	all_check()
}
...
function all_check(){
	...
	if(check1=='no'||check2=='no'||check3=='no'||check4=='no'){
		$('#withdrawal_button').html('<div style="padding: 0 18px;" onclick="no_check();">탈퇴하기</div>')
	}else{
		$('#withdrawal_button').html('<div style="padding: 0 18px;" data-bs-toggle="modal" data-bs-target="#endModal" onclick="check_default();">탈퇴하기</div>')
	}
		...
		<tr valign="top">
			...
			<td style="padding-left: 40px; width: 1000px;" align="center">
					...
					<div style="color: #222; margin: 0px;  padding: 5px 0px;">
						<div style="color: #222; margin: 0px; display: flex;">
							<div style="float: left; width: 500px;" align="left" id="title">
								<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">회원탈퇴</h3>
							</div>
						</div>
					</div>
				</div>
				<div style="padding-top: 40px;">
					<div align="left">
						<h4 style="font-size: 18px;letter-spacing: -.27px;font-weight: bold;">
						회원탈퇴에 앞서 아래 내용을 반드시 확인해 주세요.</h4>
						<div style="margin-top: 20px;padding: 24px;border: 1px solid #d3d3d3;">
							<div>
								<h5 style="font-size: 16px;letter-spacing: -.16px;">
									<div style="letter-spacing: -.16px; position: relative;font-size: 0;">
										<label style="position: relative;cursor: pointer;display: inline-block;" onclick="check1();">
											<div style="width: 24px; display: inline-block;" id="check_box1">
												<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24" style="
												width:24px; height: 24px;">
												<path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path>
												<path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
											</div>
											<span style="cursor: pointer;padding-left: 8px;display: inline-block;line-height: 24px;
										    vertical-align: top;letter-spacing: -.16px;font-size: 16px;font-weight: bold;">
										    KREAMY를 탈퇴하면 회원 정보 및 서비스 이용 기록이 삭제됩니다.</span>
										</label>
									</div>
								</h5>
								<div style="padding-top: 16px;">
									<ul style="margin: 0;padding: 0;list-style: none;">
										<li class="terms_item" style="list-style: none;font-size: 15px;letter-spacing: -.15px;position: relative;padding-left: 12px;
										...
										<li class="terms_item" style="list-style: none;font-size: 15px;etter-spacing: -.15px;position: relative;padding-left: 12px;
									    color: #333;word-break: keep-all;margin-top: 8px;">
							...
							<div style="margin-top: 40px;">
								<h5 style="margin: 0;padding: 0;font-size: 16px;letter-spacing: -.16px;">
									<div style="letter-spacing: -.16px; position: relative;font-size: 0;">
										<label style="position: relative;cursor: pointer;display: inline-block;"onclick="check2();">
											<div style="width: 24px; display: inline-block;" id="check_box2">
												<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24" style="
												width:24px; height: 24px;">
												<path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path>
												<path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
											...
											<span style="cursor: pointer;padding-left: 8px;display: inline-block;line-height: 24px;
										    vertical-align: top;letter-spacing: -.16px;font-size: 16px;font-weight: bold;">
										    관련 법령 및 내부 기준에 따라 별도 보관하는 경우에는 일부 정보가 보관될 수 있습니다.</span>
										</label>
									</div>
								</h5>
								<div style="padding-top: 16px;">
									<h6 style=" padding-bottom: 8px;font-weight: 600;font-size: 15px;letter-spacing: -.15px;">
									1. 전자상거래 등 소비자 보호에 관한 법률</h6>
									<ul style="margin: 0;padding: 0;list-style: none;">
										<li class="terms_item" style="list-style: none;font-size: 15px;letter-spacing: -.15px;position: relative;padding-left: 12px;
    									color: #333;word-break: keep-all;">
								...
								<div style="padding-top: 16px;">
									<h6 style=" padding-bottom: 8px;font-weight: 600;font-size: 15px;letter-spacing: -.15px;">
									3. 내부 기준에 따라 별도 보관</h6>
									<ul style="margin: 0;padding: 0;list-style: none;">
										<li class="terms_item" style="list-style: none;font-size: 15px;letter-spacing: -.15px;position: relative;padding-left: 12px;
    									color: #333;word-break: keep-all;">
    									부정이용 방지를 위해 이름, 이메일(로그인ID), 휴대전화번호, CI/DI: 3년 보관</li>
									</ul>
								</div>
							</div>
							<div style="margin-top: 40px;">
								<h5 style="margin: 0;padding: 0;font-size: 16px;letter-spacing: -.16px;">
									<div style="letter-spacing: -.16px; position: relative;font-size: 0;">
										<label style="position: relative;cursor: pointer;display: inline-block;"onclick="check3();">
											<div style="width: 24px; display: inline-block;" id="check_box3">
												<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24" style="
												width:24px; height: 24px;">
												<path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path>
												<path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
											...
											<span style="cursor: pointer;padding-left: 8px;display: inline-block;line-height: 24px;
										    vertical-align: top;letter-spacing: -.16px;font-size: 16px;font-weight: bold;">
										    KREAMY 탈퇴가 제한된 경우에는 아래 내용을 참고하시기 바랍니다.</span>
										</label>
									</div>
								</h5>
								<div style="padding-top: 16px;">
									<ul style="margin: 0;padding: 0;list-style: none;">
										<li class="terms_item" style="list-style: none;font-size: 15px;letter-spacing: -.15px;position: relative;padding-left: 12px;
    									color: #333;word-break: keep-all;">
    									진행 중인 거래(판매/구매)가 있을 경우: 해당 거래 종료 후 탈퇴 가능</li>
										<li class="terms_item" style="list-style: none;font-size: 15px;etter-spacing: -.15px;position: relative;padding-left: 12px;
									    color: #333;word-break: keep-all;margin-top: 8px;">
									    진행 중인 입찰(판매/구매)가 있을 경우: 해당 입찰 삭제 후 탈퇴 가능</li>
										<li class="terms_item" style="list-style: none;font-size: 15px;etter-spacing: -.15px;position: relative;padding-left: 12px;
									    color: #333;word-break: keep-all;margin-top: 8px;">
									    미납 수수료(착불 발송비/페널티)가 있을 경우: 해당 결제 완료 후 탈퇴 가능</li>
										<li class="terms_item" style="list-style: none;font-size: 15px;etter-spacing: -.15px;position: relative;padding-left: 12px;
									    color: #333;word-break: keep-all;margin-top: 8px;">
									    이용 정지 상태인 경우: 이용 정지 해제 후 탈퇴 가능</li>
									</ul>
								</div>
							</div>
						</div>
						<div style="margin-top: 20px;">
							<div style="position: relative;font-size: 0;">
								<label style="position: relative;cursor: pointer;display: inline-block;"onclick="check4();">
									<div style="width: 24px; display: inline-block;" id="check_box4">
										<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24" style="
										width:24px; height: 24px;">
										<path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path>
										<path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
									</div>
									<span style="color: #222;cursor: pointer;box-sizing: border-box;padding-left: 8px;display: inline-block;
								    line-height: 24px;vertical-align: top;letter-spacing: -.16px;font-size: 16px;">
						...
						<div style="padding-top: 40px;text-align: center;">
						    ...
						    vertical-align: middle;text-align: center;background-color: #fff;height: 42px;line-height: 40px;
						    border-radius: 12px;font-size: 14px;letter-spacing: -.14px;border: 1px solid #d3d3d3;color: rgba(34,34,34,.8);width: 120px;"
						    id="withdrawal_button">
						    <div style="padding: 0 18px;" onclick="no_check();">탈퇴하기</div></div>
							<div style=" -webkit-tap-highlight-color: rgba(0,0,0,.1);text-decoration: none;display: inline-block;cursor: pointer;
						    ...
						    onclick="location.href='<%=cp%>/profile'">취소하기</div>
						</div>
					</div>
				</div>
			</td>
...
<input type="hidden" id="check1" value="no">
<input type="hidden" id="check2" value="no">
<input type="hidden" id="check3" value="no">
<input type="hidden" id="check4" value="no">
<input type="hidden" id="check5" value="no">


<!-- Modal -->
<div class="modal fade" id="endModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content" style="width: auto;min-width: 360px;top: 360px;left: 50%;transform: translate(-50%,-50%);
		border-radius: 16px; box-shadow: 0 4px 10px 0 rgb(0 0 0 / 10%); background-color: #fff; position: absolute;" >
			<div>
				<h2 style="margin: 0;padding: 18px 50px 0;min-height: 60px;font-weight: 700;color: #000;text-align: center;
			    padding-top: 40px;line-height: normal;font-size: 20px;letter-spacing: -.3px;"> 정말 탈퇴하시겠습니까? </h2>
			</div>
			<div style="padding: 0 32px 40px;">
				<p style="margin: 0;padding: 0;padding-top: 12px;font-size: 14px;letter-spacing: -.21px;color: rgba(34,34,34,.8);text-align: center;">
				탈퇴하기 클릭 시 바로 탈퇴 처리됩니다.<br/>
				탈퇴 후 14일 이내 재가입할 수 없으며,<br/>
				재가입 시 동일 이메일을 사용할 수 없습니다.</p>
				<div style="padding-top: 24px!important;text-align: center;font-size: 0;">
					<div style="text-align: center; position: relative;margin-bottom: 20px;">
						<label style="text-align: center;position: relative;cursor: pointer;display: inline-block;" onclick="check5();">
							<div style="width: 24px;display: inline-block;" id="check_box5">
								<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24" style="width: 24px;height: 24px;">
								<path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path><path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
							</div>
							<span style="text-align: center;cursor: pointer;padding-left: 8px;display: inline-block;line-height: 24px;
						    vertical-align: top;font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.5);">KREAMY 회원을 탈퇴하겠습니다.</span>
						</label>
					</div>
					<div style="outline: none;background: none;appearance: none;display: inline-block;cursor: pointer;vertical-align: middle;
				    text-align: center;padding: 0 12px;height: 42px;line-height: 40px;border-radius: 12px;font-size: 14px;letter-spacing: -.14px;
				    background-color: #222;color: #fff;width: 120px;"data-bs-dismiss="modal"> 탈퇴 안 할래요 </div>
				    <div style="-webkit-tap-highlight-color: rgba(0,0,0,.1);font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.5);
				    display: block;margin-top: 8px;text-decoration: underline;cursor: pointer;" onclick="withdrawal();">
				    <div id="finish_button">탈퇴하기</div></div>
				</div>
			</div>
			<div style="color: inherit;-webkit-tap-highlight-color: rgba(0,0,0,.1);text-decoration: none;position: absolute;top: 18px;
   			right: 20px;cursor: pointer;"data-bs-dismiss="modal">
	   			<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-close" fill="none" viewBox="0 0 24 24" style="width: 24px; height: 24px;">
				<path fill="#222" fill-rule="evenodd" d="M11.293 12l-7.647 7.646.708.707L12 12.707l7.646 7.646.708-.707L12.707 
				12l7.647-7.646-.708-.708L12 11.293 4.354 3.646l-.708.708L11.293 12z" clip-rule="evenodd"></path></svg>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="completeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		...
		border-radius: 16px; box-shadow: 0 4px 10px 0 rgb(0 0 0 / 10%); background-color: #fff; position: absolute;" >
			<div>
				<h2 style="margin: 0;padding: 18px 50px 0;min-height: 60px;font-weight: 700;color: #000;text-align: center;
				padding-top: 40px;line-height: normal;font-size: 20px;letter-spacing: -.3px;">회원 탈퇴가 완료되었습니다.</h2>
			</div>
   			<div style="padding: 0 32px 40px;">
   				<p style="margin: 0;padding: 0;padding-top: 12px;line-height: 19px;font-size: 14px;letter-spacing: -.21px;color: rgba(34,34,34,.8);
    			text-align: center;">
    			그동안 서비스를 이용해 주셔서 감사합니다.<br/>
    			14일 후 KREAMY을 다시 이용할 수 있습니다.
    			</p>
    			
    			<div style="padding-top: 24px!important;text-align: center;font-size: 0;">
    				<div style="outline: none;background: none;appearance: none;display: inline-block;cursor: pointer;vertical-align: middle;
				    text-align: center;background-color: #fff;padding: 0 18px;height: 42px;line-height: 40px;border-radius: 12px;font-size: 14px;
				    letter-spacing: -.14px;border: 1px solid #d3d3d3;color: rgba(34,34,34,.8);width: 120px;"data-bs-dismiss="modal" >확인</div>
    			</div>
   			</div>
   			<div style="color: inherit;-webkit-tap-highlight-color: rgba(0,0,0,.1);text-decoration: none;position: absolute;top: 18px;
   			right: 20px;cursor: pointer;"data-bs-dismiss="modal">
