...
function deleteBid(bidSellNum){
	var url = "<%=cp%>/deleteBidSell"
	$.post(url,{bidSellNum:bidSellNum},function(args){})
	$(location).attr('href','<%=cp%>/selling');
}
			...
			<td style="width: 160px;">
				...
				<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/selling'"style="color: black; font-weight: bolder;">판매 내역</li>
			...
			<td style="padding-left: 40px; width: 1000px;" align="center">
					...
					<div style="color: #222; margin: 0px;  padding: 5px 0px;width: 1000px;">
						<div style="color: #222; margin: 0px; display: flex;">
							<div style="float: left; width: 500px;" align="left" id="title">
								<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">판매내역 > 입찰 중</h3>
							</div>
				...
				<div>
					<div>
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
    						...
    						font-weight: 700;"> BS-${bidSellDTO.bidSellNum } </em>
    						</h4>
						</div>
					</div>
					<div style="position: relative;border-top: 2px solid #222;">
						<div style="display: flex;padding: 16px 105px 16px 0;border-bottom: 1px solid #ebebeb;">
							<div style="-webkit-box-flex: 0;flex: none;width: 100px;height: 100px;">
								<div style="overflow: hidden;position: relative;padding-top: 100%;border-radius: 12px;background-color: rgb(244, 244, 244);">
									<img src="/img/${bidSellDTO.imageName}" 
    						...
    						align-self: center;">
								<strong style="-webkit-box-direction: normal;display: inline-flex;font-size: 14px;">${bidSellDTO.condition } · ${bidSellDTO.styleNum }</strong>
								<p style="margin: 0;padding: 0;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 2;
							    -webkit-box-orient: vertical;margin-top: 4px;font-size: 14px;">${bidSellDTO.engProduct }</p>
							    <span style="margin-top: 4px;font-size: 14px;display: inline-flex;letter-spacing: -.21px;font-weight: 700;
    							color: rgba(34,34,34,.5);">${bidSellDTO.userSize }</span>
							</div>
						</div>
								...
								<li style="list-style: none;padding: 16px 0 20px;display: table-cell;text-align: center;">
									<div style="position: relative;">
										...
										<p style="text-align: center;margin: 0;">
											<span style="display: inline-block;font-size: 14px;">${bidSellDTO.immediateBuyPrice }</span>
										</p>
									</div>
								</li>
								<li style="list-style: none;padding: 16px 0 20px;display: table-cell;text-align: center;">
									<div style="position: relative;" class="item_inner">
										...
										<p style="text-align: center;margin: 0;">
											<span style="display: inline-block;font-size: 14px;">${bidSellDTO.immediateSellPrice }</span>
										</p>
									</div>
								</li>
							</ul>
						...
						<div style="position: absolute;top: 49px;right: 0;">
						    ...
						    border: 1px solid #d3d3d3;color: rgba(34,34,34,.8);"onclick="location.href='<%=cp%>/products?prodNum=${bidSellDTO.productNum }'">상품 상세보기</div>
						</div>
					</div>
				</div>
				<div>
					<div style="margin-top: 32px;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
							<h4 style="padding: 6px 0;margin:0px;font-size: 16px;letter-spacing: -.16px;line-height: 20px;">판매 입찰 내역</h4>
						</div>
					</div>
					<div style="border-top: 2px solid #222;">
						<div style="border-bottom: 1px solid #ebebeb;">
							<div style="background-color: #fafafa;"align="left">
								<dl style="margin: 0;padding: 0;font-weight: 700;">
								    ...
								    width: 160px;font-size: 14px;line-height: 28px;">판매 희망가</dt>
									<dd style="font-weight: 700;margin: 0;padding: 26px 0;overflow: hidden;font-size: 0;">
    									...
    									vertical-align: top;">${bidSellDTO.wishPrice }</span>
									</dd>
								</dl>
							</div>
							<div style="margin: 0;padding: 20px 0;border-top: 1px solid #ebebeb;" align="left">
							    ...
							    letter-spacing: -.07px;-webkit-box-pack: start;justify-content: flex-start;">
    								...
    								line-height: 20px;letter-spacing: -.2px;">
    									<span style="color: rgba(34,34,34,.5);font-size: 14px;line-height: 20px;letter-spacing: -.2px;">배송비</span>
    								</dt>
							    	<dd style="white-space: nowrap;color: #222;font-size: 14px;margin:0; line-height: 20px;letter-spacing: -.2px;">
									선불 · 판매자 부담</dd>
							    </dl>
								<dl style="display: flex;margin:0;-webkit-box-align: center;align-items: center;min-height: 26px;font-size: 13px;
							    letter-spacing: -.07px;-webkit-box-pack: start;justify-content: flex-start;">
							    	<dt style="color: rgba(34,34,34,.5);font-size: 14px;margin-right: 12px;padding-left: 16px;width: 160px;
    								line-height: 20px;letter-spacing: -.2px;">
    									<span style="font-size: 14px;color: #222;line-height: 20px;letter-spacing: -.2px;">총 정산금액</span>
    								</dt>
							    	<dd style="margin:0px;white-space: nowrap;font-weight: 700;color: #31b46e;font-size: 14px;line-height: 20px;letter-spacing: -.2px;">
							    	${bidSellDTO.wishPrice }</dd>
							    </dl>
							</div>
							<div style="margin: 0;padding: 20px 0;border-top: 1px solid #ebebeb;" align="left">
								<dl style="display: flex;margin:0;-webkit-box-align: center;align-items: center;min-height: 26px;font-size: 13px;
						...
						<div style="display: flex;-webkit-box-pack: center;justify-content: center;">
						    ...
						    onclick="location.href='<%=cp%>/sell?prodSize=${bidSellDTO.userSize }&engProduct=${bidSellDTO.engProduct }&bidSellNum=${bidSellDTO.bidSellNum }&wishPrice=${bidSellDTO.bidSellWishPrice }'">입찰 변경하기</div>
							
							<c:if test="${bidSellDTO.immediateSellPrice!='-' }">
						    ...
						    background-color: #41b979;border-color: #41b979;color: #fff;margin-left: 8px;"
						    onclick="location.href='<%=cp%>/buy/check2?prodSize=${bidSellDTO.userSize }&engProduct=${bidSellDTO.engProduct }';">즉시 판매하기</div>
						    </c:if>
						</div>			
					</div>
				</div>
				<div align="left">
					<div style="margin-top: 40px;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
							<h4 style="color: #222;margin: 0;padding: 6px 0;font-size: 16px;letter-spacing: -.16px;line-height: 20px;"> 판매 정산 계좌 </h4>
						</div>					
					</div>
						...
						<div style="display: flex;-webkit-box-align: center;align-items: center;padding: 19px 0;">
							...
							<div style="margin-left: 17px;font-size: 0;">
								<span style="display: flex;-webkit-box-align: center;align-items: center;flex-wrap: wrap;">
									<span style="margin-left: 2px;display: inline-flex;font-size: 14px;letter-spacing: -.07px;line-height: 20px;justify-content: center;">
									${myPageDTO.account }</span>
								</span>
							</div>
						</div>
					</div>
				...
				<div align="left">
					<div style="margin-top: 40px;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
							<h4 style="color: #222;margin: 0;padding: 6px 0;font-size: 16px;letter-spacing: -.16px;line-height: 20px;"> 페널티 결제 정보 </h4>
						</div>					
					</div>
					<div style="border-top: 2px solid #222; border-bottom: 1px solid #ebebeb;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;padding: 19px 0;">
				...
				<div align="left">
					<div style="margin-top: 40px;">
						<div style="display: flex;-webkit-box-align: center;align-items: center;">
							<h4 style="color: #222;margin: 0;padding: 6px 0;font-size: 16px;letter-spacing: -.16px;line-height: 20px;"> 반송 주소 </h4>
						</div>					
					</div>
					<div style="border-top: 2px solid #222;">
				...
				<div style="padding-top: 100px;text-align: center;">
					...
					border: 1px solid #d3d3d3;color: rgba(34,34,34,.8);min-width: 120px;" onclick="location.href='<%=cp %>/selling'" >목록보기</div>
				</div>
			</td>
		</tr>
		</table>
		...
		box-shadow: 0 4px 10px 0 rgba(0,0,0,.1); " >
			...
			<div>
				...
				<div style="padding: 24px 32px 32px;display: flex;-webkit-box-pack: center;justify-content: center;">
				    ...
				    margin-left: 8px;"data-bs-dismiss="modal" onclick="deleteBid('${bidSellDTO.bidSellNum}');">입찰 지우기</div>
				</div>
			</div>
