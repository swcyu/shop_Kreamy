...
function deleteWishList(wishNum){
	event.stopPropagation();
	var url = "<%=cp%>/deleteWishList";
			...
			<td style="width: 160px;">
				...
				<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/wish'"style="color: black; font-weight: bolder;">관심 상품</li>
					</ul>
				</div>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">관심 상품</h3>
					</div>
				</div>
