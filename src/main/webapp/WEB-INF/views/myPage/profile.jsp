		...
		<tr valign="top">
			<td style="width: 160px;">
				...
				<div style="margin-top: 30px;">
					...
					<ul>
						<li class="menu" onclick="location.href='<%=cp%>/profile'"style="color: black; font-weight: bolder;">프로필 정보</li>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 1000px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">프로필 정보</h3>
					</div>
				</div>
