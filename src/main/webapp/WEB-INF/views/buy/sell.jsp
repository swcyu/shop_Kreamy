...
$(document).ready(function(){
	...
	if(${empty addrLists}||${empty bankdto}){
		$('#lbtn').attr('class','btn full solid false disabled');
	}
	
	//update시
	if(${not empty bidSellNum}&&${not empty wishPrice}){		
	...
	//카드 있으면 저기서해서안해도댈듯 $('.btn_card_add').show(); $('.regist_link').hide() $('.clickable_card').css('display','flex');
});
...
function add_card(){
	...
	if(active=='next_button_active'){
		...
		$.ajax({
			url : url,
			data : {card1:card1,card2:card2,card3:card3,card4:card4,jumin:jumin,month:month,year:year,bank:bank,tp:'s'},
		...
		if($('.cb3.hide').length==$('.cb3').length){
	 		$('#lbtn').attr('class','btn full solid sell');		
		}else{
			$('#lbtn').attr('class','btn full solid false disabled');
		}
	}	
...
<div class="wrap lg win_os">
	...
	<div class="container sell lg" style="max-width: none;">
		<div class="content">
						...
						<div class="column_box">
							<div class="buy_immediate">
										...
										<div class="instant_group">
											...
											<div id="ig2" class="price_now">
												<dl class="price_now_box">
													...
													<c:choose>
														...
														<c:otherwise>
															<span class="amount"><fmt:formatNumber value="${pbsdto.immeSellPrice }" type="number"/></span>															
															<span class="unit">원</span>
														</c:otherwise>
													</c:choose>
													</dd>
											...
											<div id="ig3" class="price_bind">												
												<dl class="price_addition">
													<dt class="price_title" style="color: rgba(34,34,34,.5); font-size: 14px; letter-spacing: -.21px;">
												...
												<dl class="price_addition">
													<dt class="price_title" style="color: rgba(34,34,34,.5); font-size: 14px; letter-spacing: -.21px;">
														<span style="color: rgba(34,34,34,.5);">배송비</span><!---->
													</dt>
											...
											<div class="price_total">
												<dl class="price_box">
													<dt class="price_title" style="color: #222;"> 총 정산금액 </dt>
													<c:choose>
														<c:when test="${empty pbsdto.immeSellPrice }">
														...
														<c:otherwise>
															<dd class="price" style="color: #31b46e;">
																<span id="totP1" class="amount" style="color: #31b46e;"><fmt:formatNumber value="${pbsdto.immeSellPrice }" type="number"/></span>
																<span class="unit" style="color: #31b46e;">원</span>
															</dd>	
														</c:otherwise>													
													</c:choose>
												</dl>												
								...
								<section id="section0" class="hide">	
									<div class="section_title">
										<h3 class="title_txt" style="font-weight: 700">최종 주문정보</h3>
									</div>
									<div class="section_content">
										<div class="instant_group">
											<div class="price_total" style="padding-top: 10px;">
												<dl class="price_box">
													<dt class="price_title" style="font-weight: 700; color: #222;"> 총 정산금액 </dt>
													<dd class="price">
														<span id="totP2" class="amount" style="color: #31b46e;">30,000</span>
														<span class="unit" style="color: #31b46e;">원</span>
													</dd>
												</dl>
											</div>
											<div id="ign1" class="price_bind"">
												<dl class="price_addition is_dark">
													<dt class="price_title">
														<span id="pppp" style="font-weight: 400; color: rgba(34,34,34,.5)">판매 희망가</span>
														<!---->
													</dt>
												...
												<dl class="price_addition">
													<dt class="price_title">
														<span style="font-weight: 400; color: rgba(34,34,34,.5)">배송비</span>														
													</dt>
													<dd class="price_text"> 선불・판매자 부담 </dd>
												</dl>
											</div>										
								...
								<section id="section6" style="display: none;">
									<div class="section_title" style="padding-bottom: 16px;">
										<h3 class="title_txt" style="line-height: 22px; font-size: 18px; letter-spacing: -.27px; font-weight: 700">판매 정산 계좌</h3>
									</div>
									<div class="section_content">
										<div class="settlement_account" style="display: flex; align-items: center;">
											<div class="account_box">
												<div class="card_info" style="padding: 0">
													<span class="card_name">국민은행</span>
													<div class="card_num" style="display: block; margin-left: 4px;">
														<span class="num_bind">
															<span class="last_num">75555448484848</span>
														</span>
													</div>
												</div>
												<dl class="account_holder">
													<dt class="holder" style="font-weight: 400">예금주</dt>
													<dd class="name">이제호</dd>
												</dl>
											</div>
										</div>
									</div>								
								...
								<section id="section2">
									<div class="section_title">
										<h3 id="s2t" class="title_txt" style="color: #222; font-weight: 700;">반송 주소</h3>
									</div>
									<div class="section_content">
									...
									<div id="s2su" class="section_unit" style="margin-top: 13px; padding-top: 13px; border-top: 1px solid #ebebeb; display: none;">
										<div class="section_title">
											<h3 class="title_txt" style="font-weight: 700; color: #222;">발송 방법</h3>
										</div>
										<div class="section_content">
								...
								<section id="section3" class="hide">
									<div class="section_title">
										<h3 class="title_txt sst" style="font-weight: 700; color: #222;">패널티 결제 방법</h3>
									</div>
									<div class="section_content">
									...
									<div type="buy">
										<ul class="check_list lg">
											...
											<li class="check_item">
												<a class="check_area">
													<div class="notice_group">
														<p class="notice_maintext">‘바로 판매하기’ 를 선택하시면 즉시 거래가 체결되며, 단순 변심이나 실수에 의한 취소가 불가능합니다.</p>
													</div>
													<div class="checkbox_item">
														<label for="undefined" class="check_label">
															<svg class="cb3" xmlns="http://www.w3.org/2000/svg" id="i-ico-check-inactive" fill="none" viewBox="0 0 24 24"><path stroke="#D3D3D3" d="M.5.5h23v23H.5z"></path><path stroke="#EBEBEB" stroke-width="1.5" d="M18.4 7.2L9.6 16l-4-4"></path></svg>
											...
											<li class="check_item">
												<a class="check_area">
													<div class="notice_group">
														<p class="notice_maintext">판매 조건을 모두 확인하였으며, 거래 진행에 동의합니다.</p>
														<!----><!---->
													</div>
													<div class="checkbox_item">
														<label for="undefined" class="check_label">
								...
								<div id="bc2" class="buy_check2" type="buy" style="border-top: 8px solid #f4f4f4;">
									<div id="bc2pt" class="price_total hide" style="padding: 20px 32px; border-top: 1px solid #ebebeb;">
										<dl class="price_box">
											<dt class="price_title" style="font-size: 15px; letter-spacing: -.15px; font-weight: 700;"> 총 정산금액 </dt>
											<dd class="price">
												<span id="totP3" class="amount" style="font-style: normal; line-height: 26px; font-size: 24px; font-weight: 600; letter-spacing: normal; color: #31b46e;">30,000</span>
												<span class="unit" style="color: #31b46e;">원</span>
											</dd>
										</dl>
									</div>
									<div class="btn_confirm">
										<a id="lbtn" disabled="disabled" type="button" class="btn full solid false ok"> 판매 계속 </a>
									</div>
								</div>
					...
					<div class="complete_detail">
						<div class="complete_info">
							<div class="complete_title">
								<p class="main_title" style="display: block;">판매 입찰이 완료되었습니다.</p>
						...
						<div class="complete_price">
							<div class="price_total">
								<dl class="price_box">
									<dt class="price_title" style="color: #222;"> 총 정산금액 </dt>
									<dd class="price">
										<span id="cTPl" class="amount" style="color: #31b46e;">30,000</span>
										<span class="unit" style="color: #31b46e;">원</span>
									</dd>
								</dl>								
							</div>
							<div class="price_bind">
								<dl class="price_addition is_dark">
									<dt class="price_title">
										<span style="color: rgba(34,34,34,.5);">판매 희망가</span>
									</dt>
...
$(document).on('click','#bi .item_link', function(){
	...
	if(${empty pbsdto.immeSellPrice}){
		...
		$('.price_box .amount').html("<fmt:formatNumber value='${pbsdto.immeSellPrice }' type='number'/>");				
...
$(document).on('focusout','.input_amount', function(){
	...
	if(price<30000){
		...
		$('.price_box .amount').html('-');
		$('.price_box .unit').html('');		
	}else if(price<='${pbsdto.immeSellPrice}'&&${not empty pbsdto.immeSellPrice}){		
		$('.tab_area.buy_tab .item').attr('class','item');
		$('#bi').addClass('on');
		$('.price_now').attr('class','price_now');
	...
	//추가할할
	if($('#di1 .address_info .name').text()==""||$('#totP1').text()=="-"||$('#dgo1').val()==""){	
		$('#lbtn').attr('class','btn full solid false disabled');
	}else{
		$('#lbtn').attr('class','btn full solid false ok');
	}
...
//주소입력공통적용input_txt
/* $(document).on('focus','.input_txt', function(){
	$(this).closest('.input_box').addClass('on_focus')
}); */
...
$(document).on('click','.btn.btn_zipcode.small.rok', function(){
	var url = "http://localhost:8080/kreamy/buy/addr";	
...
$(document).on('click','.btn.ok', function(){	
	...
	$('#section5').hide();
	$('#section6').show();
	$('#section6 .card_name').html($('#dgo1').val());
	$('#section6 .last_num').html($('#dgo2').val());
	$('#section6 .name').html($('#dgo3').val());
	$('#s2t').addClass('sst');
	$('#lbtn').attr('class','btn full solid false disabled');
	$('#lbtn').html(" 판매 입찰하기 ");
...
$(document).on('click','.btn.full.solid.sell', function(){
	...
	if($('#bb').hasClass('on')){//입찰
		...
		//여기기기
		 $.ajax({
			...
			data : {productNum:'${pIdto.prodNum}' ,wishPrice:wp ,vd:vd ,
				...
				postNum:$('.address_list.is_active .zipcode').text().replace(/[^0-9]/g,''),bidSellNum:'${bidSellNum}'},
				success : function(result) {
		...
		$('.complete_title .main_title').html("판매가 완료되었습니다.")
		$('.complete_info .complete_desc').html("즉시 판매 시 판매를 취소하실 수 없습니다.")
		$('#bddl').hide()
		var url = "<%=cp%>/buy/sellI";			
...
$(document).on('click','#acb', function(){
	$('.layer_account_registration').show();
});
//bank 변경끄기
$(document).on('click','.layer_account_registration .btn_layer_close', function(){
	$('.layer_account_registration').hide();
	$('#dropgo').val($('#dgo1').val());
	$('#dropgo2').val($('#dgo2').val());
	$('#dropgo3').val($('#dgo3').val());
	$('#savebtn').attr('class','btn2 solid medium disabled');
});

//은행들보이게 btn2 btn_dropdown
$(document).on('click','#dropgo, .btn2.btn_dropdown', function(){
...
//은행클릭 drop_link
$(document).on('click','.drop_link', function(){
	$('#dropgo').val($(this).text().trim());
	$('.layer_dropdown').hide();	
	if(($('#dropgo').val()!=$('#dgo1').val()||$('#dropgo2').val()!=$('#dgo2').val()||$('#dropgo3').val()!=$('#dgo3').val())
			&&$('#dropgo').val()!=""&&$('#dropgo2').val()!=""&&$('#dropgo3').val()!=""){
		$('#savebtn').attr('class','btn2 solid medium save');		
	}else{		
		$('#savebtn').attr('class','btn2 solid medium disabled');
	}	
});
$(document).on('focus','#dropgo2, #dropgo3', function(){
	$(this).css('border-bottom','1px solid #222');
});

$(document).on('focusout','#dropgo2, #dropgo3', function(){				
	$(this).css('border-bottom','1px solid #ebebeb');
});
$(document).on('input','#dropgo2, #dropgo3', function(){
	if($(this).val().length<2){
		$(this).closest('.input_box').attr('class','input_box has_error');
		$(this).closest('.input_box').find('.input_error').show();
	}else{
	...
	if((($('#dropgo').val()!=$('#dgo1').val()||$('#dropgo2').val()!=$('#dgo2').val()||$('#dropgo3').val()!=$('#dgo3').val())
			&&$('#dropgo').val()!=""&&$('#dropgo2').val()!=""&&$('#dropgo3').val()!="")&&!$(this).closest('.input_box').hasClass('has_error')){
		$('#savebtn').attr('class','btn2 solid medium save');		
	}else{		
		$('#savebtn').attr('class','btn2 solid medium disabled');
	}
...
//저장하기 클릭
$(document).on('click','.btn2.save', function(){	
	var url = "<%=cp%>/buy/bank";		
	$.ajax({
		url : url,
		data : {bank:$('#dropgo').val(),account:$('#dropgo2').val(),holder:$('#dropgo3').val()},
		success : function(result) {
			var refine = $("#section5").html(result).find('#section5').children();
     		$('#section5').html(refine);      
		}
	});	
	$('#savebtn').attr('class','btn2 solid medium disabled');
	$('.layer_account_registration').hide();
	//추가할할
	if($('#di1 .address_info .name').text()==""||$('#totP1').text()=="-"){	
		$('#lbtn').attr('class','btn full solid false disabled');
	}else{
		$('#lbtn').attr('class','btn full solid false ok');
	}
...
$(document).on('click','#zxcv', function(){
	...
	if($('#bb').hasClass('on')){//입찰
		location.href='<%=cp %>/bidSellDetail?sellNum='+$('#abcd').text();	
	}else{
		location.href='<%=cp %>/tradeSellDetail?sellNum='+$('#abcd').text();
	}
