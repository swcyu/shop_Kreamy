			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">자주 묻는 질문 추가</h3>
					</div>
...
<!-- 				버튼 -->	
				...
				<table class="" style="width: 1000px; font-size: 13px;">
					...
					<tr>
						<td style="width: 150px; font-size: 15px; padding-left: 20px; padding-bottom: 10px;"><b>자주 묻는 질문 카테고리</b></td>
						...
						<td align="left" style="padding-bottom: 10px;">
							<div style="width: 400px;position: relative; border: solid 1px #ebebeb; border-radius: 10px;" align="left" >
								...
								id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
									<input type="text" placeholder="선택하세요." id="searchKey1" class="searchKey" name="FAQCategory" value="${dto.FAQCategory }"
								...
								<div class="check_list_close" id="check_list1" style="height: 120px;">
									<div style="padding: 4px 0px 4px 10px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting1('이용정책');" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">이용정책</div>
									<div style="padding: 4px 0px 4px 10px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting1('공통');" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">공통</div>
					...
					<tr>
						<td align="right" style="width: 200px; font-size: 15px; padding-right: 50px;"><b>자주 묻는 질문 제목</b></td>
						...
						<td align="left">
							...
							border: solid 1px #ebebeb; border-radius: 10px;" >
								<input name="FAQTitle" type="text" placeholder="제목을 입력하세요. (최대 80자)" value="${dto.FAQTitle }"
					...
					<tr style="height: 350px;">
						<td align="right" valign="top" style="width: 200px; font-size: 15px; padding-right: 50px; padding-top: 20px;"><b>자주 묻는 질문 내용</b></td>
						...
						<td align="left">
							...
							style="width: 700px; height:330px; text-align: left; padding-left: 10px; font-size: 14px; border: solid 1px #ebebeb; border-radius: 10px;" >
								<textarea placeholder="문의하실 내용을 입력해주세요." id="FAQContent" name="FAQContent">${dto.FAQContent }</textarea>
							</div>
	 					</td>
					...
					<tr style="height: 200px;" align="center">
						<td colspan="2" valign="top" align="center" style="width: 150px; font-size: 15px; padding-top: 20px;">
							...
							<div style="width: 1000px;">
								...
								<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
								border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
								onclick="location.href='<%=cp%>/adminFAQList'" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
