			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">공지사항</h3>
					</div>
...
<!-- 				버튼 -->	
				...
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td align="left" style="font-size: 20px; padding-left: 20px;"><b>[${dto.noticeCategory }] ${dto.noticeTitle }</b></td>
					
					<td align="right" style="font-size: 15px; padding-right: 20px;">${dto.noticeCreated }</td>
				...
				<tr style="height: 200px;" align="center">
					<td colspan="2" valign="top" align="center" style="width: 150px; font-size: 15px; padding-top: 20px;">
						...
						<div style="width: 1000px;">
							...
							border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/adminNoticeUpdate?noticeNum='+${dto.noticeNum}+'&pageNum='+${pageNum}" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="noticeNum" value="${dto.noticeNum }"/>
								<font style="letter-spacing: -.6px;">공지사항  수정</font>
							</span>

							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/adminNoticeDelete?noticeNum='+${dto.noticeNum }+'&pageNum='+${pageNum}" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="noticeNum" value="${dto.noticeNum }"/>
								<font style="letter-spacing: -.6px;">공지사항  삭제</font>
							</span>
