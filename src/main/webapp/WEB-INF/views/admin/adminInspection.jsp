...
function checkList(){
	...
	var check = document.getElementById("check_list").className;
	if(check == 'check_list_open'){
		document.getElementById("check_list").className="check_list_close";
	}else{
		document.getElementById("check_list").scrollTop=0;
		document.getElementById("check_list").className="check_list_open";
	}
}

function searchKey_setting(key){
	document.getElementById("check_list").className="check_list_close";
		...
		<tr valign="top">
			<td style="width: 160px;">
				...
				<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/adminInspection'"style="color: black; font-weight: bolder;">상품검수 관리</li>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 230px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">상품검수 관리</h3>
					</div>
					<div style="float: right;width: 115px;position: relative;" align="right" >
						<div style="position: relative; cursor: pointer;" onclick="checkList();">
							<input type="text" placeholder="구매/판매" id="searchKey" class="searchKey" 
    						readonly="readonly" style="cursor: pointer;padding: 6px 0px;"/>
						...
						<div class="check_list_close" id="check_list">
							<div style="padding-left:10px;padding-top:4px;font-size: 15px; color: #222;"align="left" onclick="searchKey_setting('구매');">구매</div>
							<div style="padding-left:10px;padding-top:4px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting('판매');">판매</div>
						</div>		
					</div>
					<div style="float: right;width: 582px;margin-left: 8px;" align="right">
						<div style="position: relative;padding: 0 40px 0 44px;height: 34px;background-color: #f4f4f4;border-radius: 8px;">
							<svg xmlns="http://www.w3.org/2000/svg" id="i-ico-search-gray" fill="none" viewBox="0 0 24 24" style="width: 24px;
							    height: 24px;position: absolute;top: 5px;left: 12px;">
							<path fill="#BBB" fill-rule="evenodd"d="M18 10.5a7.5 7.5 0 11-15 0 7.5 7.5 0 0115 0zm-1.146 5.646a8.5 8.5 0 10-.708.708l4.5 4.5.708-.708-4.5-4.5z" 
							clip-rule="evenodd"></path></svg>
							<input type="text" placeholder="거래상태로 검색" style="margin: 0;color: #222;padding: 0;outline: 0;border: 0;
						    resize: none;border-radius: 0;background-color: rgba(0,0,0,0);width: 100%;height: 100%;transition: all .1s;font-size: 14px;
						    letter-spacing: -.21px;"id="searchValue"/>
						</div>
					</div>
					<div style="float: right;width: 60px;margin-left: 5px;" align="right">
						<div style="width: 58px;height: 34px; padding: 7px 14px ;border-radius: 10px;cursor: pointer;
						border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" onclick="search_data();">
							<font style="letter-spacing: -.6px; ">검색</font>
						</div>
					</div>
				...
				<div style="width: 1000px; padding:12px; border-bottom: 1px solid #ebebeb;">
					...
					<tr>
						<td align="center" style="width: 80px;">
							<div style="width: 80px;">번호
							</div>
						</td>			
						<td align="center" style="width: 80px;">
							<div style="font-size: 14px; color: #222">상품사진</div>	
						</td>			
						<td align="left" style="width:300px; padding-left: 16px;">
							<div style="font-size: 14px; color: #222">상품정보</div>					
						</td>		
						<td align="center" style="width: 150px;font-size: 14px;letter-spacing: -.21px;">
							<div style="font-size: 14px; color: #222">구매정보</div>
						<td align="center" style="width: 150px;font-size: 14px;letter-spacing: -.21px;">
							<div style="font-size: 14px; color: #222;">판매정보</div>
						</td>
						<td align="center" style="width: 106px;font-size: 14px;letter-spacing: -.21px;">거래일</td>
						<td align="center" style="width:110px;;font-size: 14px;letter-spacing: -.21px;">수정하기					
						</td>				
					</tr>
					</table>
				</div>
