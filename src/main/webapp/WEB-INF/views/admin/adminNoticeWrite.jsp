...
function sendData(){
	...
	f.action = "<%=cp%>/adminNoticeWrite_ok";
	f.submit();
...
function searchKey_setting1(key){
	...
	if(key == '공지'){
		...
		document.getElementById("noticeContent").value="안녕하세요. KREAMY입니다.\n\n\n\n\n\n\n\n\n\n감사합니다.";
		
	}else if(key == '이벤트 발표'){
		
		document.getElementById("noticeContent").value="안녕하세요. KREAMY입니다.\n\n\n\n\n\n\n\n\n\n유의사항\n"+
		"※당첨 회원님께는 [월/일(요일)] 당첨 안내 SMS를 발송해드립니다.\n※당첨 안내는 가입하신 회원정보의 휴대폰 번호와 이메일로 발송되며, 잘못될 개인정보로 인한 당첨취소에 대해서는 당사에서 책임지지 않습니다.\n"+
		"※정산 금액은 이메일 안내에 포함된 서류를 모두 전달해주시면 입금이 진행되며, 입금일 전날 다시 한 번 이메일로 안내드립니다.";
			...
			<td style="width: 160px;">
				...
				<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/adminNoticeList'" style="color: black; font-weight: bolder;">공지사항 관리</li>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">공지사항 추가</h3>
					</div>
...
<!-- 				버튼 -->	
					<div style="float: right;width: 500px;" align="right">
						...
						onclick="location.href='<%=cp%>/adminNoticeList'">
							<font style="letter-spacing: -.6px; ">공지사항 목록</font>
						</div>
					</div>
				...
				<table class="" style="width: 1000px; font-size: 13px;">
					...
					<tr>
						<td style="width: 150px; font-size: 15px; padding-left: 35px; padding-bottom: 10px;"><b>공지사항 카테고리</b></td>
						...
						<td align="left" style="padding-bottom: 10px;">
							<div style="width: 400px;position: relative; border: solid 1px #ebebeb; border-radius: 10px;" align="left" >
								...
								id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
									<input type="text" placeholder="선택하세요." id="searchKey1" class="searchKey" name="noticeCategory"
								...
								<div class="check_list_close" id="check_list1">
									<div style="padding: 4px 0px 4px 10px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting1('공지');" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">공지</div>
									<div style="padding: 4px 0px 4px 10px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting1('이벤트 발표');" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">이벤트 발표</div>
									<div style="padding: 4px 0px 4px 10px; font-size: 15px; color: #222;"align="left" onclick="searchKey_setting1('쇼룸');" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">쇼룸</div>
								</div>		
							</div>
					...
					<tr>
						<td align="right" style="width: 200px; font-size: 15px; padding-right: 70px;"><b>공지사항 제목</b></td>
						...
						<td align="left">
							...
							border: solid 1px #ebebeb; border-radius: 10px;" >
								<input name="noticeTitle" type="text" placeholder="제목을 입력하세요. (최대 80자)"
					...
					<tr style="height: 350px;">
						<td align="right" valign="top" style="width: 200px; font-size: 15px; padding-right: 70px; padding-top: 20px;"><b>공지사항 내용</b></td>
						...
						<td align="left">
							...
							style="width: 700px; height:330px; text-align: left; padding-left: 10px; font-size: 14px; border: solid 1px #ebebeb; border-radius: 10px;" >
								<textarea placeholder="문의하실 내용을 입력해주세요." id="noticeContent" name="noticeContent"></textarea>
							</div>
	 					</td>
					...
					<tr style="height: 200px;" align="center">
						<td colspan="2" valign="top" align="center" style="width: 150px; font-size: 15px; padding-top: 20px;">
							...
							<div style="width: 1000px;">
								...
								onclick="sendData();" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
									<font style="letter-spacing: -.6px;">작성완료</font>
								</span>
	
								<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
								border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
								onclick="location.href='<%=cp%>/adminNoticeList'" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
									<font style="letter-spacing: -.6px;">작성취소</font>
								</span>
