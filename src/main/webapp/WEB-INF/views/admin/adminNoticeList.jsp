			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">공지사항 관리</h3>
					</div>
...
<!-- 				버튼 -->	
					<div style="float: right;width: 500px;" align="right">
						...
						onclick="location.href='<%=cp%>/adminNoticeWrite'">
							<font style="letter-spacing: -.6px; ">공지사항 추가</font>
						</div>
					</div>
				...
				<table class="noticeListContent" style="width: 1000px; font-size: 13px;">
					...
					<c:forEach var="dto" items="${lists }">
						...
						onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
							<td style="font-size: 15px; padding-left: 20px;">[${dto.noticeCategory }] ${dto.noticeTitle }</td>
