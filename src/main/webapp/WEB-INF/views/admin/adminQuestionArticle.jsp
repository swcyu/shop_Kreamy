...
function sendData(){
	...
	f.action = "<%=cp%>/adminQuestionArticle_ok";
	f.submit();
...
function updateChange(){
	...
	//답변수정 - 1. 수정창 열기 / 2.버튼(updateBtn) 바꾸기 - 수정완료, 클릭시 수정하기 함수 실행 answerContent_update_btn
	document.getElementById("answerContent_update").style.display="";
	document.getElementById("answerContent_update_btn").style.display="";
	
	document.getElementById("answerContent_show").style.display="none";
	document.getElementById("answerContent_show_btn").style.display="none";
	
//	document.getElementById("updateBtn").onclick="updateData();";
//	document.getElementById("updateBtn").html('<input type="hidden" name="questionNum" value="${dto.questionNum }"/><font style="letter-spacing: -.6px;">수정완료</font>');
...
function updateData(){
	...
	f.action = "<%=cp%>/adminQuestionUpdate";
	f.submit();
			...
			<td style="width: 160px;">
				...
				<div>
					...
					<ul>
						...
						<li class="menu" onclick="location.href='<%=cp%>/adminQuestionList'" style="color: black; font-weight: bolder;">문의 관리</li>
			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">문의 관리</h3>
					</div>
...
<!-- 				버튼 -->	
					<div style="float: right;width: 500px;" align="right">
						...
						onclick="location.href='<%=cp%>/adminQuestionList'">
							<font style="letter-spacing: -.6px; ">문의 목록</font>
						</div>
					</div>
			...
			<form action="" name="myForm" method="post">	
				...
				<!-- 문의유형1 / 문의유형2 / 제목 / 작성일 / 상태 -->
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td style="width: 30px; font-size: 20px; padding-left: 20px;">
						<div style="width: 35px; height: 35px; text-align: center; line-height: 30px; border-radius: 20px; background-color: #ededed; color: #222222; font-size: 20px;">
						<b>Q</b>
						</div>
					</td>

					<td align="right" style="width: 60px;"><b>[${dto.questionType1 }]</b></td>
					<td align="left" style="width: 150px;"><b>&nbsp;${dto.questionType2 }</b></td>
					<td align="left" style="font-size: 18px;"><b>${dto.questionSubject }</b></td>
					<td align="center" style="width: 100px; color: #919191;">${dto.questionCreated }</td>

					<td align="center" style="width: 100px; ">
						<c:if test="${dto.questionStatus=='답변대기' }">
							<div style="width: 70px; height: 20px; text-align: center; line-height: 20px; border-radius: 10px; background-color: #e0e0e0; color: #8c8c8c;">
							${dto.questionStatus }
							</div>
						</c:if>

						<c:if test="${dto.questionStatus=='답변완료' }">
							<div style="width: 70px; height: 20px; text-align: center; line-height: 20px; border-radius: 10px; background-color: #000000; color: #ffffff;">
							${dto.questionStatus }
							</div>
						</c:if>
					</td>
				...
				<c:if test="${!empty dto.brandName }">
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td style="width: 30px;">
					</td>
				
					<td colspan="2" align="left" style="width: 210px; padding-left: 65px; font-size: 13px;">
						<b>브랜드명</b>
  					</td>
				...
				<c:if test="${!empty dto.tradeNum }">
				<c:if test="${dto.tradeNum>0 }">
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td style="width: 30px;">
					</td>
				...
				<c:if test="${!empty dto.buyRouteDetail }">
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td style="width: 30px;">
					</td>
				...
				<c:if test="${!empty dto.sellPriceDetail }">
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					<td style="width: 30px;">
					</td>
				...
				<!-- 내용 -->
				<tr style="border-bottom: solid 3px #222;">
					<td colspan="6" align="left">
						<div align="left" style="padding: 50px; font-size: 14px; position: relative; font-size: 15px; line-height: 2;">
							${dto.questionContent }
						</div>
<!-- 						
						<div align="left" style="padding: 50px;">
							<img src="resources/image/etc/plus_font.jpg" width="100px" style="padding-right: 10px;"/>
							<img src="resources/image/etc/plus_font.jpg" width="100px" style="padding-right: 10px;"/>
							<img src="resources/image/etc/plus_font.jpg" width="100px" style="padding-right: 10px;"/>
 ...
 -->
 			...
 			<!-- 답변 없는 경우 -->	
 			<c:if test="${empty adto.answerContent }">
				<tr id="answerContent_write" style="height: 350px;">
					<td style="width: 30px;">
					</td>
				
					<td valign="top" colspan="2" style="width: 210px; font-size: 13px; padding-left: 65px; padding-top: 30px;"><b>문의 답변</b></td>

					<td colspan="3" align="left" style="padding-top: 20px;">
						<div align="left" 
						style="height:330px; text-align: left; padding-left: 10px; font-size: 14px; border: solid 1px #ebebeb; border-radius: 10px;" >
							<textarea placeholder="문의에 대한 답변 내용을 입력해주세요." name="answerContent">안녕하세요. 회원님
KREAMY 고객센터입니다.

-------------------------------------------------------
문의에 대한 답변 내용을 이 곳에 입력해주세요.
-------------------------------------------------------

KREAMY를 이용해주셔서 감사드리며,
...
KREAMY 고객센터 드림.
				...
				<tr style="height: 200px;" align="center">
					<td colspan="6" valign="top" align="center" style="width: 150px; font-size: 15px; padding-left: 20px; padding-top: 20px;">
						...
						<div style="width: 1000px;">
							...
							<input type="hidden" name="questionNum" value="${dto.questionNum }"/>
								<font style="letter-spacing: -.6px;">답변저장</font>
							</span>

							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/adminQuestionList'" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<font style="letter-spacing: -.6px;">답변취소</font>
							</span>
			...
			<!-- 답변 있는 경우 -->	
			<c:if test="${!empty adto.answerContent }">
				<tr id="answerContent_show" style="font-size: 15px; color: #ababab; border-bottom: solid 3px #222;">
					<td colspan="6" align="left" style="padding: 20px;">
						<div style="width: 35px; height: 35px; text-align: center; line-height: 30px; border-radius: 20px; background-color: #222; color: #fff; font-size: 20px;">
						<b>A</b>
						</div>
						
						<div align="left" style="padding: 30px; font-size: 14px; position: relative; font-size: 15px; line-height: 2; color: #222;">
							${adto.answerContent}
						</div>
				...
				<!-- 버튼 자리 -->
				<tr id="answerContent_show_btn" style="height: 200px;" align="center">
					<td colspan="6" valign="top" align="center" style="width: 150px; font-size: 15px; padding-left: 20px; padding-top: 20px;">

						<div style="width: 1000px;">
							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="updateBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="updateChange();" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="questionNum" value="${dto.questionNum }"/>
								<font style="letter-spacing: -.6px;">답변수정</font>
							</span>

							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/adminQuestionDelete?questionNum='+${dto.questionNum }" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="questionNum" value="${dto.questionNum }"/>
								<font style="letter-spacing: -.6px;">답변삭제</font>
							</span>
				...
				<!-- 수정창 자리 -->
				<tr id="answerContent_update" style="height: 350px; display: none;">
					<td style="width: 30px;">
					</td>
					...
					<td colspan="3" align="left" style="padding-top: 20px;">
						<div align="left" 
						style="height:330px; text-align: left; padding-left: 10px; font-size: 14px; border: solid 1px #ebebeb; border-radius: 10px;" >
							<textarea placeholder="" name="answerContent">
								${updateAnswerContent }
							</textarea>
						</div>
 					</td>
				...
				<!-- 버튼 자리 -->
				<tr id="answerContent_update_btn" style="height: 200px; display: none;" align="center">
					<td colspan="6" valign="top" align="center" style="width: 150px; font-size: 15px; padding-left: 20px; padding-top: 20px;">

						<div style="width: 1000px;">
							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="updateBtn" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="updateData();" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="questionNum" value="${dto.questionNum }"/>
								<font style="letter-spacing: -.6px;">수정완료</font>
							</span>

							<span style="width: 108px;height: 34px; padding: 7px 14px ; margin-right: 10px; border-radius: 10px;cursor: pointer;
							border: 1px solid #222;font-size: 12px;" align="center" id="addAddr" data-bs-toggle="modal" data-bs-target="#addrModal"
							onclick="location.href='<%=cp%>/adminQuestionArticle?questionNum='+${dto.questionNum }" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
								<input type="hidden" name="questionNum" value="${dto.questionNum }"/>
								<font style="letter-spacing: -.6px;">수정취소</font>
							</span>
