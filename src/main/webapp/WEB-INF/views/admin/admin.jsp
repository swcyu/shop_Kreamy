		...
		<tr valign="top">
			...
			<div style="padding-top:5px; width: 1000px;">
				...
				display: flex;"align="left" >				
					...
					<div style="display: inline-block; width: 220px;" align="center">
						<img src="/img/KreamyBanner.png" height="100px;">
					</div>
					<div style="display: inline-block; width: 500px; font-size: 30px; font-weight: 700;padding-top: 10px;"align="center" >
						<div>
							KREAMY 관리자 페이지
						</div>
						<div style="font-size: 17px; font-weight: 500; color: #c8c8c8;">
							kreamy@kreamy.co.kr
						</div>
						<div style="font-size: 14px; font-weight: 500;color: #c8c8c8;">
							회원 수 : ${userCount }명
						</div>
					</div>
				...
				<div style="width: 1000px; padding-bottom: 14px; margin-top:56px; "align="left">
					...
					<tr>
						<td align="left" width="500px" height="40px" valign="bottom">
							<h3 style="font-size: 18px;margin:0px;font-weight: 700;">등록 상품 정보</h3>
						</td>
						<td align="right" width="500px" valign="bottom">
							<font style="font-size: 13px; letter-spacing: -.07px; color: rgba(34,34,34,.5);">
							<p onclick="location.href='<%=cp%>/adminProduct'" style="cursor: pointer;margin: 0px;">관리하기 <i class="fas fa-chevron-right"></i>
							</p></font>
				...
				<div style="width: 1000px; height: 96px; background-color: #fafafa; border-radius: 12px; cursor: pointer;" >
					<div style="padding-top: 15px;">
						<table>
						<tr style="height: 66px;"onclick="location.href='<%=cp%>/adminProduct'">
							<td valign="top" align="center" style="width: 170px;border-right: 1px solid #ebebeb ;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">전체</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">
								${sneakersCount+appraelCount+goodsCount+lifeCount+techCount }</font>
							</td>
							<td valign="top" align="center" style="width: 166px;"> 
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">스니커즈</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">${sneakersCount }</font>
							</td>
							<td valign="top" align="center" style="width: 166px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">의류</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">${appraelCount }</font>
							</td>
							<td valign="top" align="center" style="width: 166px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">패션 잡화</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">${goodsCount }</font>
							</td>
							<td valign="top" align="center" style="width: 166px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">라이프</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">${lifeCount }</font>
							</td>
							<td valign="top" align="center" style="width: 166px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">테크</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">${techCount }</font>
							</td>
				...
				<div style="width: 1000px; padding-bottom: 14px; margin-top:56px; "align="left">
					...
					<tr>
						<td align="left" width="500px" height="40px" valign="bottom">
							<h3 style="font-size: 18px;margin:0px;font-weight: 700;">금일 거래 정보</h3>
						</td>
						<td align="right" width="500px" valign="bottom">
							<font style="font-size: 13px; letter-spacing: -.07px; color: rgba(34,34,34,.5);">
							<p onclick="location.href='<%=cp%>/adminInspection'" style="cursor: pointer;margin: 0px;">관리하기 <i class="fas fa-chevron-right"></i>
							</p></font>
				...
				<div style="width: 1000px; height: 96px; background-color: #fafafa; border-radius: 12px; cursor: pointer;" >
					<div style="padding-top: 15px;">
						<table>
						<tr style="height: 66px;" onclick="location.href='<%=cp%>/adminInspection'">
							<td valign="top" align="center" style="width: 250px;border-right: 1px solid #ebebeb ;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">전체</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">
								${bidBuyCount+bidSellCount+tradeCount }</font>
							</td>
							<td valign="top" align="center" style="width: 250px;"> 
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">구매 입찰</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;color: #f15746;">
								${bidBuyCount }</font>
							</td>
							<td valign="top" align="center" style="width: 250px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">판매 입찰</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;color: #31b46e;">
								${bidSellCount }</font>
							</td>
							<td valign="top" align="center" style="width: 250px;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">거래 체결</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;color: #8977ad;">
								${tradeCount }</font>
							</td>
						</tr>
						</table>
				...
				<div style="width: 1000px; padding-bottom: 14px; margin-top:56px; "align="left">
					...
					<tr>
						<td align="left" width="500px" height="40px" valign="bottom">
							<h3 style="font-size: 18px;margin:0px;font-weight: 700;">등록 문의 정보</h3>
						</td>
						<td align="right" width="500px" valign="bottom">
							<font style="font-size: 13px; letter-spacing: -.07px; color: rgba(34,34,34,.5);">
							<p onclick="location.href='<%=cp%>/adminQuestionList'" style="cursor: pointer;margin: 0px;">관리하기 <i class="fas fa-chevron-right"></i>
							</p></font>
				...
				<div style="width: 1000px; height: 96px; background-color: #fafafa; border-radius: 12px; cursor: pointer;" >
					<div style="padding-top: 15px;">
						<table>
						<tr style="height: 66px;" onclick="location.href='<%=cp%>/adminQuestionList'">
							<td valign="top" align="center" style="width: 500px;border-right: 1px solid #ebebeb ;">
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">금일 등록 질문 수</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">
								${questionCount }</font>
							</td>
							<td valign="top" align="center" style="width: 500px;"> 
								<font style="font-size: 13px;letter-spacing: -.07px;color: rgba(34,34,34,.8);">미답변 질문 수</font><br/>
								<font style="margin-top: 2px; font-size: 18px;line-height: 20px;letter-spacing: -.09px;font-weight: 700;">
								${questionNoAnswerCount }</font>
							</td>
						</tr>
						</table>
					</div>
