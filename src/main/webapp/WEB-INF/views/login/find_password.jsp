	...
	<div class="help_area">
		<div>
			...
			<div class="help_notice">
				<p class="notice_txt"> 가입 시 등록하신 휴대폰 번호와 이메일을 입력하시면,<br>이메일로 임시 비밀번호를 전송해 드립니다. </p>
			</div>
			...
			<div class="help_btn_box">
				<a id="find_pwd" onclick="phoneCheck();" href="#" type="button" class="btn full solid disabled"> 이메일 발송하기 </a>
			</div>
		</div>
	</div>
</div>
