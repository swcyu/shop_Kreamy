					...
					<div class="header_top" style="box-shadow: 0 1px 0 0 rgb(0 0 0 / 10%);">
						...
						<div class="header_main" style="" >
							...
							<div class="main_inner" style="display: flex; padding: 0 10px; height: 75px; min-width: 320px; align-items: center;" >
								<h1 style="margin-top: 14px;padding-top: 12px;" >
...
<div class="login_area">
	...
	<div class="e_input_box">
		...
		<div class="input_item">
			<input type="text" name="email" value="" placeholder="예) kreamy@kreamy.co.kr" autocomplete="off" class="e_input_txt"/>
		</div>
	...
	<div class="login_btn_box">
		...
		<div id="naver_id_login" style="text-align:center">
			<a href="${url}" class="btn_naver">
				<img src="/img/naver_logo.png" width="50px" height="48px" style="float: left; margin-right: -50px; padding-left: 2px; padding-top: 4px;">
				네이버 로그인
			</a>
		</div>
	</div>
