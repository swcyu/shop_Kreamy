			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px; padding-left: 5px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">내 문의 상세</h3>
					</div>
					...
					<div style="float: right;width: 500px;" align="right">
						...
						onclick="location.href='<%=cp%>/questionList?pageNum='+${pageNum}">
				...
				<tr style="height: 50px; border-bottom: solid 1px #ebebeb;">
					...
					<td colspan="2" align="left" style="width: 210px; padding-left: 50px; font-size: 13px;">
						<b>브랜드명</b>
  					</td>
				...
				<tr style="font-size: 15px; color: #ababab;">
					<td colspan="6" align="center" style="padding: 30px;"><b>답변을 기다리고 있습니다.</b></td>
				</tr>
				</c:if>
