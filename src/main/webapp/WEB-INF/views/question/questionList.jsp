			...
			<div style="padding-top:5px">
				<div style="color: #222; margin: 0px; display: flex; padding: 5px 0px 16px; border-bottom: 3px solid #222;">
					<div style="float: left; width: 500px; padding-left: 5px;" align="left">
						<h3 style="font-size: 28px;letter-spacing: -.36px;margin: 0px;font-weight: 700;">1 : 1 문의</h3>
					</div>
					...
					<div style="float: right;width: 500px;" align="right">
						...
						onclick="location.href='<%=cp%>/questionWrite?userNum=${userNum }'">
							<font style="letter-spacing: -.6px;">1 : 1 문의하기</font>
						</div>
					</div>
				...
				<table class="questionListContent" style="width: 1000px; font-size: 13px;">



				<c:forEach var="dto" items="${questionLists }">
					<tr class="questionListContent" onclick="location.href='<%=cp%>/questionArticle?questionNum=${dto.questionNum }&pageNum=${pageNum}';" 
					onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor=''">
						...
						<td align="right" style="width: 50px;"><b>[${dto.questionType1 }]</b></td>
						<td align="left" style="width: 130px;"><b>&nbsp;${dto.questionType2 }</b></td>
						<td align="left">${dto.questionSubject }</td>
